...
func (c *chatClient) Chat(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientEvent, ServerEvent], error) {
...
type Chat_ChatClient = grpc.BidiStreamingClient[ClientEvent, ServerEvent]
...
func (UnimplementedChatServer) Chat(grpc.BidiStreamingServer[ClientEvent, ServerEvent]) error {
...
func _Chat_Chat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChatServer).Chat(&grpc.GenericServerStream[ClientEvent, ServerEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Chat_ChatServer = grpc.BidiStreamingServer[ClientEvent, ServerEvent]
